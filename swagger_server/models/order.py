...
class Order(Model):
    ...
    """
    def __init__(self, id: int=None, word_id: int=None, quantity: int=None, ship_date: datetime=None, status: str=None, complete: bool=False):  # noqa: E501
        """Order - a model defined in Swagger

        :param id: The id of this Order.  # noqa: E501
        :type id: int
        :param word_id: The word_id of this Order.  # noqa: E501
        :type word_id: int
    ...
    def word_id(self) -> int:
        """Gets the word_id of this Order.


        :return: The word_id of this Order.
        :rtype: int
        """
        return self._word_id

    @word_id.setter
    def word_id(self, word_id: int):
        """Sets the word_id of this Order.


        :param word_id: The word_id of this Order.
        :type word_id: int
        """
